...
import { ControlPotabilidadDetailComponent } from './pages/control-potabilidad-detail/control-potabilidad-detail.component';
...
export const control_potabilidad_ROUTES: Routes = [
    ...
    { path: ':id', component: ControlPotabilidadDetailComponent },
