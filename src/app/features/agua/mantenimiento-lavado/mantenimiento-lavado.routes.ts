...
import { MantenimientoLavadoDetailComponent } from './pages/mantenimiento-lavado-detail/mantenimiento-lavado-detail.component';
...
export const mantenimiento_lavado_ROUTES: Routes = [
    ...
    { path: ':id', component: MantenimientoLavadoDetailComponent },
