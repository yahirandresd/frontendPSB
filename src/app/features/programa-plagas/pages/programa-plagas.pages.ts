    ...
    readonly secciones: SeccionModulo[] = [
        {
            ...
            descripcion: 'Actividades de inspección, fumigación y revisión de trampas',
            icono: 'pi pi-clipboard',
            ruta: 'registro-plagas',
            color: 'border-blue-300 hover:border-blue-500'
        },
        {
            label: 'Hallazgos',
            descripcion: 'Registro de plagas detectadas y su clasificación',
            icono: 'pi pi-search',
            ruta: 'hallazgos',
        ...
        {
            label: 'Trampas',
            descripcion: 'Inventario y estado de trampas instaladas por área',
        ...
        },
        {
            ...
            descripcion: 'Seguimiento de acciones derivadas de hallazgos',
            icono: 'pi pi-check-circle',
            ruta: 'acciones-correctivas',
            color: 'border-green-300 hover:border-green-500'
        },
        {
            label: 'Áreas',
            descripcion: 'Zonas del establecimiento bajo control de plagas',
        ...
        {
            label: 'Plaguicidas',
            descripcion: 'Productos autorizados y sus condiciones de uso',
            icono: 'pi pi-box',
            ruta: 'plaguicidas',
            color: 'border-red-300 hover:border-red-500'
        },
        {
            label: 'Empresas fumigadoras',
            descripcion: 'Empresas autorizadas para el control de plagas',
            icono: 'pi pi-building',
            ruta: 'empresa-fumigadora',
            color: 'border-blue-300 hover:border-blue-500'
        },
        {
            label: 'Evidencias',
            descripcion: 'Registros fotográficos y documentos de soporte',
            icono: 'pi pi-images',
            ruta: 'evidencia-plagas',
            color: 'border-yellow-300 hover:border-yellow-500'
        },
        {
            label: 'Tipos de plagas',
            descripcion: 'Clasificación y caracterización de plagas',
            icono: 'pi pi-sitemap',
            ruta: 'tipo-plaga',
            color: 'border-orange-300 hover:border-orange-500'
        },
        {
            label: 'Cronogramas',
            descripcion: 'Programación de actividades y seguimientos',
