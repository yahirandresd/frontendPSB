...
export class ControlPotabilidadEditComponent implements OnInit, HasUnsavedChanges {
    ...
    async onSubmit(data: any) {
        ...
        try {
            ...
            if (actualizado.requiereAnalisisLaboratorio) {
                this.messageService.add({
                    severity: 'warn',
                    summary: 'Análisis de laboratorio requerido',
                    detail: `Parámetros fuera de rango: ${actualizado.parametroFueraRango}`
                });
                setTimeout(() => {
